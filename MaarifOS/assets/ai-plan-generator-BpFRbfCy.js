...
> 💡 *Bana doğrudan bir soru yöneltebilirsiniz. Örneğin: **"Ağlayan çocuğu nasıl sakinleştiririm?"** veya **"Uzay temalı bir tekerleme yaz"**.*`,suggestedAction:`copy`,category:`chat`}}function S(e){let t=``;return t=e.includes(`plan`)?`#### 🪄 Günlük & Aylık Plan Nasıl Yapılır?
1. **Günlük Plan Sihirbazı (Sekme 1):** Ekranın solundaki 1. sekmeye girin. Konuyu girin; çiplere (Kavramlar, Materyaller, Rutinler) tek tek dokunun, klavye kullanmadan resmî EK-6 planınız saniyeler içinde oluşur.
2. **528 MEB Kitap Havuzu (Sekme 2):** MEB'in 9 resmî ders kitabından 528 gerçek etkinliği inceleyebilir, "Sihirbaza Aktar" butonuyla anında plana dönüştürebilirsiniz.
...
- **Hızlı Dokunmatik Yoklama:** Ana ekranda her çocuğun yanındaki **[✓ Var 🟢]**, **[✗ Yok 🔴]**, **[⏱ Geç 🟡]** butonlarına dokunarak 20 çocuk için 20 saniyede yoklama alabilirsiniz.
...
- **Sekme 1:** Akıllı Günlük Plan Sihirbazı (EK-6)
...
- **Sekme 8:** AI Pedagoji Asistanı (Şu an buradasınız!)`,{markdown:`### 🧭 MaarifOS Kullanım & Gezinme Kılavuzu
${t}

> 🖨️ **Çıktı Alma:** Tüm plan ve evraklarda **[🖨️ A4 Yazdır]** butonuna bastığınızda ekran gereksiz menülerden arınarak birebir resmî A4 kağıt formuna bükülür.`,suggestedAction:`copy`,category:`help`}}function C(e,t){return e.includes(`ağl`)||e.includes(`ayrılık`)||e.includes(`annemi`)?{markdown:`### 🧸 Okula Uyum & Ağlayan Çocuğu Sakinleştirme Rehberi
...
3. **Rutin Hatırlatması:**
   - Günde 3 sabit tuvalet geçiş rutini (Etkinlik öncesi, yemek sonrası, bahçe dönüşü) uygulayın.`,suggestedAction:`copy`,category:`behavior`}}function w(e,t,n){return e.includes(`tekerleme`)?{markdown:`### 🎵 "${t}" Temalı Eğlenceli Okul Öncesi Tekerlemesi
...
3. Sınıfımızda ${t} gibi merak ettiğin ne var?`,suggestedAction:`copy`,category:`creative`}}function T(e,t,n){let r=e.includes(`matematik`)||e.includes(`sayı`),i=e.includes(`fen`)||e.includes(`deney`);return r?{markdown:`### 🎲 Matematik Oyunu: "Sayı Dedektifleri ve Renkli Halkalar"
...
- Ritim durup öğretmen *"Kökler toprağa tutundu!"* dediğinde herkes tek ayak üzerinde dengede heykel olur.`,suggestedAction:`copy`,category:`game`}}function E(e,t,n){return{markdown:`### 💡 Pedagojik Danışmanlık & Çözüm Masası
**Soru:** *"${e}"*
...
> 📌 **TYMM Eğilim Kodu:** E1.1 Merak ve E2.4 İş Birliğine Açıklık.`,suggestedAction:`copy`,category:`general`}}function D(e,t){return{markdown:`### 🌧️ Acil Kurtarıcı: Yağmurlu Gün & Sınıf İçi Enerji Boşaltma
...
> 💡 **Pedagojik Not:** Ani hareket-durdurma oyunları prefrontal korteksi uyararak öz düzenleme ve inhibitör kontrol (dürtü denetimi) becerisini pekiştirir.`,suggestedAction:`copy`,category:`emergency`}}function O(){return{markdown:`### 🕊️ Barış Masası & Oyuncak Paylaşamama Çözüm Protokolü
...
> 🤝 **Ritüel Kapanışı:** İki çocuk el sıkışır ya da "Barış Çakı" yapar. Öğretmen süreci kolaylaştırır, hüküm vermez.`,suggestedAction:`copy`,category:`emergency`}}function k(e,t){return{markdown:`### ♻️ Sıfır Bütçe & Doğal Atık Etkinlik Reçetesi
...
> 🍃 **TYMM Notu:** Sıfır atık yaklaşımı çocukta tüketim çılgınlığı yerine üretici ve çevreci eğilim (E3.8) geliştirir.`,suggestedAction:`copy`,category:`emergency`}}function A(e,t,n){return{markdown:`### 📱 Tek Tıkla Hazır Veli WhatsApp Bülteni
...
> 💡 *Aşağıdaki **"WhatsApp'a Gönder"** butonuna basarak metni doğrudan veli grubunuza aktarabilirsiniz.*`,suggestedAction:`whatsapp`,category:`family`}}function j(e,t){return{markdown:`### 📝 Resmî EK-2 Anekdot Kayıt Formu Taslağı
...
Çocuğun uzamsal algısı ve problem çözme becerisi yaş düzeyine uygundur. Fen ve matematik merkezinde rampa deneyleri sunularak merakı desteklenecektir.`,suggestedAction:`copy`,category:`anecdote`}}function M(e){return{markdown:`### 🎓 Dönem Sonu Resmî Gelişim Raporu (Karne) Pedagojik Görüş Bankası
...
- *"Küçük kas koordinasyonu gerektiren makas, boya ve montaj çalışmalarında oldukça titiz ve özgün ürünler ortaya koymaktadır."*`,suggestedAction:`copy`,category:`general`}}function N(e,t){return{markdown:`### 🎯 Bireyselleştirilmiş Farklılaştırma (BEP & Zenginleştirme)
...
2. **Merkez Kolaylaştırıcılığı:** Malzeme yöneticisi rolü verilerek sorumluluk duygusu desteklenir.`,suggestedAction:`copy`,category:`differentiation`}}function P(e,t){return{markdown:`### 🔍 Merak ve Keşif Uyandıran 5 Açık Uçlu Araştırma Sorusu
